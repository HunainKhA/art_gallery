                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        {art.status && (art.status.toLowerCase() === 'return' || art.status.toLowerCase() === 'archive' || art.status.toLowerCase() === 'archived') ? (
                          <span className="status-return status-archive" style={{ fontSize: '12px', fontWeight: 200, color: '#f59e0b', fontFamily: 'Montserrat, sans-serif' }}>
                            Archive
                          </span>
                        ) : art.status && (art.status.toLowerCase() === 'sold' || art.status.toLowerCase() === 'soldout' || art.status.toLowerCase() === 'sold_out') ? (
                          <span className="status-sold" style={{ fontSize: '12px', fontWeight: 200, color: '#ef4444', fontFamily: 'Montserrat, sans-serif' }}>
                            Sold
                          </span>
                        ) : (
                          <>
                            <span className="status-inquiry" style={{ fontSize: '12px', fontWeight: 200, color: 'var(--text-primary)', fontFamily: 'Montserrat, sans-serif' }}>
                              Inquiry
                            </span>
                            <span className="status-available" style={{ fontSize: '12px', fontWeight: 200, color: '#10b981', fontFamily: 'Montserrat, sans-serif' }}>
                              Available
                            </span>
                          </>
                        )}
