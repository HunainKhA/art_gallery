                  ...
                  {hasLetter && (
                    <div style={{ marginLeft: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.75rem', backgroundColor: 'rgba(255, 255, 255, 0.01)', border: '1px dashed var(--border-color)', padding: '1.5rem', borderRadius: '8px' }}>
                      <div style={{ display: 'flex', gap: '1.5rem' }}>
                        <label style={{ display: 'flex', alignItems: 'center', gap: '0.45rem', fontSize: '0.8rem', color: '#fff', cursor: 'pointer', userSelect: 'none' }}>
                          <input 
                            type="radio" 
                            name="letter_type" 
                            checked={isAuto} 
              ...
              <div key={field.name} style={{ gridColumn: isFullWidth ? 'span 2' : 'span 1' }}>
                ...
                {field.type === 'textarea' ? (
                  <textarea 
                    ...
                    style={{ width: '100%', padding: '0.7rem', background: 'var(--bg-input)', border: '1px solid var(--border-color)', borderRadius: '8px', color: '#fff', resize: 'none' }}
                  />
                ) : field.type === 'select' ? (
                  <select 
                    value={formData[field.name] || ''}
